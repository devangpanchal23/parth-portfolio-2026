        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {entries.map(([slug, project]) => (
            <div key={slug} className="group">
              ...
              >
                <img src={project.heroImage} alt={project.title} className="w-full h-full object-cover portfolio-media-responsive portfolio-media-responsive--zoom" loading="lazy" />
